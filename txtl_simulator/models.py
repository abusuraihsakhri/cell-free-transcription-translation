"""
Data Models & Telemetry Definitions for TX-TL Engine: Cell-Free Protein Synthesis & Kinetic ODE Simulator.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Cell-Free Systems Biology Models"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
